package com.livedrof.springStarter.rocketmq.orderProduce;

import com.livedrof.springStarter.rocketmq.Utils;
...
public class Producer {
    public static void main(String[] args) throws UnsupportedEncodingException {
        try {
            ...
            orderedProducer.setNamesrvAddr(Utils.NAME_SERVER_ADDRESS);
